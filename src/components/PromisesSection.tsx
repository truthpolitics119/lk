      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-14">
          <div className="inline-flex items-center gap-2 bg-[#8B0000]/30 border border-[#8B0000]/50 rounded-full px-4 py-1.5 mb-4">
            ...
            <span className="text-[#FF6B6B] text-sm font-semibold uppercase tracking-widest">{t("section.sn1")}</span>
          </div>
          <h2 className="text-3xl md:text-5xl font-black text-white mb-4">
            {t("cta.see_promises").split("|")[0]} <span className="text-[#DAA520]">{t("cta.see_promises").split("|")[1]}</span>
          </h2>
